...
class ProcessingResult:
    ...
    @classmethod
    def success_result(cls, items_processed: int = 0, embeddings_saved: int = 0, 
                      embeddings_skipped: int = 0, total_tokens: int = 0,
                      total_cost: float = 0.0, total_requests: int = 0,
                      points_created: List = None) -> 'ProcessingResult':
    ...
    def combine_with(self, other: 'ProcessingResult') -> 'ProcessingResult':
        ...
        combined_points = self.points_created + other.points_created
